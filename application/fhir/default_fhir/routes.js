var routesDefaultFHIR = function(app, DefaultFHIR){
	...
	app.get('/:apikey/administrative-gender-code/code/:code?', DefaultFHIR.get.administrativeGenderCode);
	...
	app.get('/:apikey/activity-reasons/code/:code?', DefaultFHIR.get.activityReasonCode);
