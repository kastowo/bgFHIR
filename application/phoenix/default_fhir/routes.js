var routesDefaultFHIR = function(app, DefaultFHIR){
	...
	app.get('/:apikey/count-data-table/:table', DefaultFHIR.get.checkRow);
	...
	app.get('/:apikey/Quantity', DefaultFHIR.get.quantity);
	...
	app.get('/:apikey/Dosage', DefaultFHIR.get.dosage);
	...
	app.get('/:apikey/immunization-evaluation-status/:_id?', DefaultFHIR.get.immunizationEvaluationStatus);
	app.get('/:apikey/immunization-evaluation-status/code/:code?', DefaultFHIR.get.immunizationEvaluationStatusCode);
	app.get('/:apikey/immunization-evaluation-target-disease/:_id?', DefaultFHIR.get.immunizationEvaluationTargetDisease);
	app.get('/:apikey/immunization-evaluation-target-disease/code/:code?', DefaultFHIR.get.immunizationEvaluationTargetDiseaseCode);
	app.get('/:apikey/immunization-evaluation-dose-status/:_id?', DefaultFHIR.get.immunizationEvaluationDoseStatus);
	app.get('/:apikey/immunization-evaluation-dose-status/code/:code?', DefaultFHIR.get.immunizationEvaluationDoseStatusCode);
	app.get('/:apikey/immunization-evaluation-dose-status-reason/:_id?', DefaultFHIR.get.resourceTypes);
	app.get('/:apikey/immunization-evaluation-dose-status-reason/code/:code?', DefaultFHIR.get.resourceTypesCode);
	
  app.get('/:apikey/coverage-type/:_id?', DefaultFHIR.get.coverageType);
  app.get('/:apikey/coverage-type/code/:code?', DefaultFHIR.get.coverageTypeCode);
  app.get('/:apikey/policyholder-relationship/:_id?', DefaultFHIR.get.policyholderRelationship);
  app.get('/:apikey/policyholder-relationship/code/:code?', DefaultFHIR.get.policyholderRelationshipCode);
  app.get('/:apikey/remittance-outcome/:_id?', DefaultFHIR.get.remittanceOutcome);
  app.get('/:apikey/remittance-outcome/code/:code?', DefaultFHIR.get.remittanceOutcomeCode);
  app.get('/:apikey/benefit-category/:_id?', DefaultFHIR.get.benefitCategory);
  app.get('/:apikey/benefit-category/code/:code?', DefaultFHIR.get.benefitCategoryCode);
  app.get('/:apikey/benefit-subcategory/:_id?', DefaultFHIR.get.benefitSubcategory);
  app.get('/:apikey/benefit-subcategory/code/:code?', DefaultFHIR.get.benefitSubcategoryCode);
  app.get('/:apikey/benefit-network/:_id?', DefaultFHIR.get.benefitNetwork);
  app.get('/:apikey/benefit-network/code/:code?', DefaultFHIR.get.benefitNetworkCode);
  app.get('/:apikey/benefit-unit/:_id?', DefaultFHIR.get.benefitUnit);
  app.get('/:apikey/benefit-unit/code/:code?', DefaultFHIR.get.benefitUnitCode);
  app.get('/:apikey/benefit-term/:_id?', DefaultFHIR.get.benefitTerm);
  app.get('/:apikey/benefit-term/code/:code?', DefaultFHIR.get.benefitTermCode);
  app.get('/:apikey/benefit-type/:_id?', DefaultFHIR.get.benefitType);
  app.get('/:apikey/benefit-type/code/:code?', DefaultFHIR.get.benefitTypeCode);
  app.get('/:apikey/claim-type/:_id?', DefaultFHIR.get.claimType);
  app.get('/:apikey/claim-type/code/:code?', DefaultFHIR.get.claimTypeCode);
  app.get('/:apikey/claim-subtype/:_id?', DefaultFHIR.get.claimSubtype);
  app.get('/:apikey/claim-subtype/code/:code?', DefaultFHIR.get.claimSubtypeCode);
  app.get('/:apikey/claim-use/:_id?', DefaultFHIR.get.claimUse);
  app.get('/:apikey/claim-use/code/:code?', DefaultFHIR.get.claimUseCode);
  app.get('/:apikey/process-priority/:_id?', DefaultFHIR.get.processPriority);
  app.get('/:apikey/process-priority/code/:code?', DefaultFHIR.get.processPriorityCode);
  app.get('/:apikey/fundsreserve/:_id?', DefaultFHIR.get.fundsreserve);
  app.get('/:apikey/fundsreserve/code/:code?', DefaultFHIR.get.fundsreserveCode);
  app.get('/:apikey/related-claim-relationship/:_id?', DefaultFHIR.get.relatedClaimRelationship);
  app.get('/:apikey/related-claim-relationship/code/:code?', DefaultFHIR.get.relatedClaimRelationshipCode);
  app.get('/:apikey/payeetype/:_id?', DefaultFHIR.get.payeetype);
  app.get('/:apikey/payeetype/code/:code?', DefaultFHIR.get.payeetypeCode);
  app.get('/:apikey/ex-payee-resource-type/:_id?', DefaultFHIR.get.exPayeeResourceType);
  app.get('/:apikey/ex-payee-resource-type/code/:code?', DefaultFHIR.get.exPayeeResourceTypeCode);
  app.get('/:apikey/claim-careteamrole/:_id?', DefaultFHIR.get.claimCareteamrole);
  app.get('/:apikey/claim-careteamrole/code/:code?', DefaultFHIR.get.claimCareteamroleCode);
  app.get('/:apikey/provider-qualification/:_id?', DefaultFHIR.get.providerQualification);
  app.get('/:apikey/provider-qualification/code/:code?', DefaultFHIR.get.providerQualificationCode);
  app.get('/:apikey/claim-informationcategory/:_id?', DefaultFHIR.get.claimInformationcategory);
  app.get('/:apikey/claim-informationcategory/code/:code?', DefaultFHIR.get.claimInformationcategoryCode);
  app.get('/:apikey/claim-exception/:_id?', DefaultFHIR.get.claimException);
  app.get('/:apikey/claim-exception/code/:code?', DefaultFHIR.get.claimExceptionCode);
  app.get('/:apikey/missing-tooth-reason/:_id?', DefaultFHIR.get.missingToothReason);
  app.get('/:apikey/missing-tooth-reason/code/:code?', DefaultFHIR.get.missingToothReasonCode);
  app.get('/:apikey/icd-10/:_id?', DefaultFHIR.get.icd10);
  app.get('/:apikey/icd-10/code/:code?', DefaultFHIR.get.icd10Code);
  app.get('/:apikey/ex-diagnosistype/:_id?', DefaultFHIR.get.exDiagnosistype);
  app.get('/:apikey/ex-diagnosistype/code/:code?', DefaultFHIR.get.exDiagnosistypeCode);
  app.get('/:apikey/ex-diagnosisrelatedgroup/:_id?', DefaultFHIR.get.exDiagnosisrelatedgroup);
  app.get('/:apikey/ex-diagnosisrelatedgroup/code/:code?', DefaultFHIR.get.exDiagnosisrelatedgroupCode);
  app.get('/:apikey/icd-10-procedures/:_id?', DefaultFHIR.get.icd10Procedures);
  app.get('/:apikey/icd-10-procedures/code/:code?', DefaultFHIR.get.icd10ProceduresCode);
  app.get('/:apikey/v3-ActIncidentCode/:_id?', DefaultFHIR.get.v3ActIncidentCode);
  app.get('/:apikey/v3-ActIncidentCode/code/:code?', DefaultFHIR.get.v3ActIncidentCodeCode);
  app.get('/:apikey/ex-revenue-center/:_id?', DefaultFHIR.get.exRevenueCenter);
  app.get('/:apikey/ex-revenue-center/code/:code?', DefaultFHIR.get.exRevenueCenterCode);
  app.get('/:apikey/service-uscls/:_id?', DefaultFHIR.get.serviceUscls);
  app.get('/:apikey/service-uscls/code/:code?', DefaultFHIR.get.serviceUsclsCode);
  app.get('/:apikey/claim-modifiers/:_id?', DefaultFHIR.get.claimModifiers);
  app.get('/:apikey/claim-modifiers/code/:code?', DefaultFHIR.get.claimModifiersCode);
  app.get('/:apikey/ex-program-code/:_id?', DefaultFHIR.get.exProgramCode);
  app.get('/:apikey/ex-program-code/code/:code?', DefaultFHIR.get.exProgramCodeCode);
  app.get('/:apikey/service-place/:_id?', DefaultFHIR.get.servicePlace);
  app.get('/:apikey/service-place/code/:code?', DefaultFHIR.get.servicePlaceCode);
  app.get('/:apikey/tooth/:_id?', DefaultFHIR.get.tooth);
  app.get('/:apikey/tooth/code/:code?', DefaultFHIR.get.toothCode);
  app.get('/:apikey/surface/:_id?', DefaultFHIR.get.surface);
  app.get('/:apikey/surface/code/:code?', DefaultFHIR.get.surfaceCode);
  app.get('/:apikey/adjudication-reason/:_id?', DefaultFHIR.get.adjudicationReason);
  app.get('/:apikey/adjudication-reason/code/:code?', DefaultFHIR.get.adjudicationReasonCode);
  app.get('/:apikey/ex-paymenttype/:_id?', DefaultFHIR.get.exPaymenttype);
  app.get('/:apikey/ex-paymenttype/code/:code?', DefaultFHIR.get.exPaymenttypeCode);
  app.get('/:apikey/payment-adjustment-reason/:_id?', DefaultFHIR.get.paymentAdjustmentReason);
  app.get('/:apikey/payment-adjustment-reason/code/:code?', DefaultFHIR.get.paymentAdjustmentReasonCode);
  app.get('/:apikey/payment-status/:_id?', DefaultFHIR.get.paymentStatus);
  app.get('/:apikey/payment-status/code/:code?', DefaultFHIR.get.paymentStatusCode);
  app.get('/:apikey/payment-type/:_id?', DefaultFHIR.get.paymentType);
  app.get('/:apikey/payment-type/code/:code?', DefaultFHIR.get.paymentTypeCode);
  app.get('/:apikey/explanationofbenefit-status/:_id?', DefaultFHIR.get.explanationofbenefitStatus);
  app.get('/:apikey/explanationofbenefit-status/code/:code?', DefaultFHIR.get.explanationofbenefitStatusCode);
  app.get('/:apikey/resource-type-link/:_id?', DefaultFHIR.get.resourceTypeLink);
  app.get('/:apikey/resource-type-link/code/:code?', DefaultFHIR.get.resourceTypeLinkCode);
  app.get('/:apikey/v3-ActInvoiceGroupCode/:_id?', DefaultFHIR.get.v3ActInvoiceGroupCode);
  app.get('/:apikey/v3-ActInvoiceGroupCode/code/:code?', DefaultFHIR.get.v3ActInvoiceGroupCodeCode);	
	//post
	...
	app.post('/:apikey/Dosage', DefaultFHIR.post.dosage);
	app.post('/:apikey/Quantity', DefaultFHIR.post.quantity);
  ...
  app.post('/:apikey/resource-types', DefaultFHIR.post.resourceTypes);
	...
	app.post('/:apikey/immunization-evaluation-status', DefaultFHIR.post.immunizationEvaluationStatus);
	app.post('/:apikey/immunization-evaluation-target-disease', DefaultFHIR.post.immunizationEvaluationTargetDisease);
	app.post('/:apikey/immunization-evaluation-dose-status', DefaultFHIR.post.immunizationEvaluationDoseStatus);
	app.post('/:apikey/immunization-evaluation-dose-status-reason', DefaultFHIR.post.immunizationEvaluationDoseStatusReason);
	
  app.post('/:apikey/coverage-type', DefaultFHIR.post.coverageType);
  app.post('/:apikey/policyholder-relationship', DefaultFHIR.post.policyholderRelationship);
  app.post('/:apikey/remittance-outcome', DefaultFHIR.post.remittanceOutcome);
  app.post('/:apikey/benefit-category', DefaultFHIR.post.benefitCategory);
  app.post('/:apikey/benefit-subcategory', DefaultFHIR.post.benefitSubcategory);
  app.post('/:apikey/benefit-network', DefaultFHIR.post.benefitNetwork);
  app.post('/:apikey/benefit-unit', DefaultFHIR.post.benefitUnit);
  app.post('/:apikey/benefit-term', DefaultFHIR.post.benefitTerm);
  app.post('/:apikey/benefit-type', DefaultFHIR.post.benefitType);
  app.post('/:apikey/claim-type', DefaultFHIR.post.claimType);
  app.post('/:apikey/claim-subtype', DefaultFHIR.post.claimSubtype);
  app.post('/:apikey/claim-use', DefaultFHIR.post.claimUse);
  app.post('/:apikey/process-priority', DefaultFHIR.post.processPriority);
  app.post('/:apikey/fundsreserve', DefaultFHIR.post.fundsreserve);
  app.post('/:apikey/related-claim-relationship', DefaultFHIR.post.relatedClaimRelationship);
  app.post('/:apikey/payeetype', DefaultFHIR.post.payeetype);
  app.post('/:apikey/ex-payee-resource-type', DefaultFHIR.post.exPayeeResourceType);
  app.post('/:apikey/claim-careteamrole', DefaultFHIR.post.claimCareteamrole);
  app.post('/:apikey/provider-qualification', DefaultFHIR.post.providerQualification);
  app.post('/:apikey/claim-informationcategory', DefaultFHIR.post.claimInformationcategory);
  app.post('/:apikey/claim-exception', DefaultFHIR.post.claimException);
  app.post('/:apikey/missing-tooth-reason', DefaultFHIR.post.missingToothReason);
  app.post('/:apikey/icd-10', DefaultFHIR.post.icd10);
  app.post('/:apikey/ex-diagnosistype', DefaultFHIR.post.exDiagnosistype);
  app.post('/:apikey/ex-diagnosisrelatedgroup', DefaultFHIR.post.exDiagnosisrelatedgroup);
  app.post('/:apikey/icd-10-procedures', DefaultFHIR.post.icd10Procedures);
  app.post('/:apikey/v3-ActIncidentCode', DefaultFHIR.post.v3ActIncidentCode);
  app.post('/:apikey/ex-revenue-center', DefaultFHIR.post.exRevenueCenter);
  app.post('/:apikey/service-uscls', DefaultFHIR.post.serviceUscls);
  app.post('/:apikey/claim-modifiers', DefaultFHIR.post.claimModifiers);
  app.post('/:apikey/ex-program-code', DefaultFHIR.post.exProgramCode);
  app.post('/:apikey/service-place', DefaultFHIR.post.servicePlace);
  app.post('/:apikey/tooth', DefaultFHIR.post.tooth);
  app.post('/:apikey/surface', DefaultFHIR.post.surface);
  app.post('/:apikey/adjudication-reason', DefaultFHIR.post.adjudicationReason);
  app.post('/:apikey/ex-paymenttype', DefaultFHIR.post.exPaymenttype);
  app.post('/:apikey/payment-adjustment-reason', DefaultFHIR.post.paymentAdjustmentReason);
  app.post('/:apikey/payment-status', DefaultFHIR.post.paymentStatus);
  app.post('/:apikey/payment-type', DefaultFHIR.post.paymentType);
  app.post('/:apikey/explanationofbenefit-status', DefaultFHIR.post.explanationofbenefitStatus);
  app.post('/:apikey/resource-type-link', DefaultFHIR.post.resourceTypeLink);
  app.post('/:apikey/v3-ActInvoiceGroupCode', DefaultFHIR.post.v3ActInvoiceGroupCode);
	...
	app.put('/:apikey/Dosage/:_id?/:dr?', DefaultFHIR.put.dosage);
	app.put('/:apikey/Quantity/:_id?/:dr?', DefaultFHIR.put.quantity);
  ...
  app.put('/:apikey/resource-types/:_id', DefaultFHIR.put.resourceTypes);
	...
	app.put('/:apikey/immunization-evaluation-status/:_id', DefaultFHIR.put.immunizationEvaluationStatus);
	app.put('/:apikey/immunization-evaluation-target-disease/:_id', DefaultFHIR.put.immunizationEvaluationTargetDisease);
	app.put('/:apikey/immunization-evaluation-dose-status/:_id', DefaultFHIR.put.immunizationEvaluationDoseStatus);
	app.put('/:apikey/immunization-evaluation-dose-status-reason/:_id', DefaultFHIR.put.immunizationEvaluationDoseStatusReason);
	
  app.put('/:apikey/coverage-type/:_id', DefaultFHIR.put.coverageType);
  app.put('/:apikey/policyholder-relationship/:_id', DefaultFHIR.put.policyholderRelationship);
  app.put('/:apikey/remittance-outcome/:_id', DefaultFHIR.put.remittanceOutcome);
  app.put('/:apikey/benefit-category/:_id', DefaultFHIR.put.benefitCategory);
  app.put('/:apikey/benefit-subcategory/:_id', DefaultFHIR.put.benefitSubcategory);
  app.put('/:apikey/benefit-network/:_id', DefaultFHIR.put.benefitNetwork);
  app.put('/:apikey/benefit-unit/:_id', DefaultFHIR.put.benefitUnit);
  app.put('/:apikey/benefit-term/:_id', DefaultFHIR.put.benefitTerm);
  app.put('/:apikey/benefit-type/:_id', DefaultFHIR.put.benefitType);
  app.put('/:apikey/claim-type/:_id', DefaultFHIR.put.claimType);
  app.put('/:apikey/claim-subtype/:_id', DefaultFHIR.put.claimSubtype);
  app.put('/:apikey/claim-use/:_id', DefaultFHIR.put.claimUse);
  app.put('/:apikey/process-priority/:_id', DefaultFHIR.put.processPriority);
  app.put('/:apikey/fundsreserve/:_id', DefaultFHIR.put.fundsreserve);
  app.put('/:apikey/related-claim-relationship/:_id', DefaultFHIR.put.relatedClaimRelationship);
  app.put('/:apikey/payeetype/:_id', DefaultFHIR.put.payeetype);
  app.put('/:apikey/ex-payee-resource-type/:_id', DefaultFHIR.put.exPayeeResourceType);
  app.put('/:apikey/claim-careteamrole/:_id', DefaultFHIR.put.claimCareteamrole);
  app.put('/:apikey/provider-qualification/:_id', DefaultFHIR.put.providerQualification);
  app.put('/:apikey/claim-informationcategory/:_id', DefaultFHIR.put.claimInformationcategory);
  app.put('/:apikey/claim-exception/:_id', DefaultFHIR.put.claimException);
  app.put('/:apikey/missing-tooth-reason/:_id', DefaultFHIR.put.missingToothReason);
  app.put('/:apikey/icd-10/:_id', DefaultFHIR.put.icd10);
  app.put('/:apikey/ex-diagnosistype/:_id', DefaultFHIR.put.exDiagnosistype);
  app.put('/:apikey/ex-diagnosisrelatedgroup/:_id', DefaultFHIR.put.exDiagnosisrelatedgroup);
  app.put('/:apikey/icd-10-procedures/:_id', DefaultFHIR.put.icd10Procedures);
  app.put('/:apikey/v3-ActIncidentCode/:_id', DefaultFHIR.put.v3ActIncidentCode);
  app.put('/:apikey/ex-revenue-center/:_id', DefaultFHIR.put.exRevenueCenter);
  app.put('/:apikey/service-uscls/:_id', DefaultFHIR.put.serviceUscls);
  app.put('/:apikey/claim-modifiers/:_id', DefaultFHIR.put.claimModifiers);
  app.put('/:apikey/ex-program-code/:_id', DefaultFHIR.put.exProgramCode);
  app.put('/:apikey/service-place/:_id', DefaultFHIR.put.servicePlace);
  app.put('/:apikey/tooth/:_id', DefaultFHIR.put.tooth);
  app.put('/:apikey/surface/:_id', DefaultFHIR.put.surface);
  app.put('/:apikey/adjudication-reason/:_id', DefaultFHIR.put.adjudicationReason);
  app.put('/:apikey/ex-paymenttype/:_id', DefaultFHIR.put.exPaymenttype);
  app.put('/:apikey/payment-adjustment-reason/:_id', DefaultFHIR.put.paymentAdjustmentReason);
  app.put('/:apikey/payment-status/:_id', DefaultFHIR.put.paymentStatus);
  app.put('/:apikey/payment-type/:_id', DefaultFHIR.put.paymentType);
  app.put('/:apikey/explanationofbenefit-status/:_id', DefaultFHIR.put.explanationofbenefitStatus);
  app.put('/:apikey/resource-type-link/:_id', DefaultFHIR.put.resourceTypeLink);
  app.put('/:apikey/v3-ActInvoiceGroupCode/:_id', DefaultFHIR.put.v3ActInvoiceGroupCode);	
}
